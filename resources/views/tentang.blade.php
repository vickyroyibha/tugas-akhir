			...
			<div class="col-md-12">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						seperti Badan Pusat Statistik (BPS) dan Badan Kependudukan dan Keluarga Berencana Nasional (BKKBN). Data kesehatan nasional dapat diakses melalui situs resmi Depkes RI yaitu <a href="http://www.depkes.go.id/folder/view/01/structure-web-content-publikasi-data.html"> depkes.go.id </a>, 
						dimana data yang disajikan adalah data kesehatan nasional yang dibagi kedalam empat fakta kategori yaitu fakta sarana kesehatan, fakta tenaga kesehatan, fakta kesehatan keluarga, dan fakta pengendalian penyakit. 
						Data yang disajikan dari 34 provinsi yang ada di Indonesia dalam kurun waktu 3 tahun yaitu dari tahun 2013, 2014, dan tahun 2015.</p>
